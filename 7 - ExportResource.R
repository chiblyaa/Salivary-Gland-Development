...
library(Seurat)
## This script will transfer final annotations to the integrated files
## To generate ready-to-use resource and final cell type-defining gene lists
...
cell.type.levels <- c("End bud", "Krt19+ duct", "Basal duct", "Myoepithelial", "Bpifa2+ Proacinar", "Smgc+ Proacinar", "Mitotic cells",
                      "Serous acinar", "Seromucous acinar", "Gstt1+ Female", "Gstt1+ Male", "Intercalated duct", "Ascl3+ duct", "GCT", "Striated duct",    
...
smg.p.integrated <- RenameIdents(smg.p.integrated, "Smgc+ Female" = "Gstt1+ Female", 
                                 "Smgc+" = "Gstt1+ Female", #these are from adult SMG which was female
                                 "Smgc+ Male" = "Gstt1+ Male", 
                                 "Acinar" = "Seromucous acinar",
...
#### Split individual objects with final annotations for SGAMAP
